...
### [1.101.1-alpha.05f63cadcf07019ff02f3bbb9a74cd52a770880f](https://github.com/bigcommerce/checkout-sdk-js/compare/v1.37.0...v1.101.1-alpha.05f63cadcf07019ff02f3bbb9a74cd52a770880f) (2020-09-24)
...
* **checkout:** CHECKOUT-4465 Make state/province optional for certain countries based on requireState flag ([d177113](https://github.com/bigcommerce/checkout-sdk-js/commit/d17711351f676933e60388415b7f4b7839bf33f3))
...
* **checkout:** INT-1916 Make barclaycard compatible with offsite strategy ([cdf578b](https://github.com/bigcommerce/checkout-sdk-js/commit/cdf578b835918a6f1f822854b1c396fd8f337376))
...
* **common:** PAYPAL-7 Pass in merchant ID on PayPal button script for PayPal Express Checkout ([99d4142](https://github.com/bigcommerce/checkout-sdk-js/commit/99d41429e675d6010d7b6ea01c030319e115a50d))
* **common:** PAYPAL-7 Pass in merchant ID on PayPal button script for PayPal Express Checkout ([dee37aa](https://github.com/bigcommerce/checkout-sdk-js/commit/dee37aac4ca80fe075da8aa179314a9cad3c8fdd))
...
* **payment:** INT-1901 Use modal to handle 3DS for Adyen ([038836f](https://github.com/bigcommerce/checkout-sdk-js/commit/038836fb433a80993747f26cd6395c6b24202319))
* **payment:** INT-1902 Support vaulting with instrument_type ([6f77be9](https://github.com/bigcommerce/checkout-sdk-js/commit/6f77be9738d271f3146cb9662cf139ee0064c936))
* **payment:** INT-1902 Update payment method id and instrument selector to support gateway ([7709c45](https://github.com/bigcommerce/checkout-sdk-js/commit/7709c45f8f76ae18611f414a97e58016e5a20221))
...
* **payment:** PAYMENTS-4616 Add support for paying with a vaulted paypal account ([4f98f39](https://github.com/bigcommerce/checkout-sdk-js/commit/4f98f396b155731778afaa0067dec153b366fe5b))
* **payment:** PAYMENTS-4616 Add support for vaulting Paypal Accounts ([6b578ea](https://github.com/bigcommerce/checkout-sdk-js/commit/6b578ea1e85992b7a38e0bf27e52a822d6c9d1e5))
* **payment:** PAYMENTS-4759 Add support for filtering instruments ([5dfa155](https://github.com/bigcommerce/checkout-sdk-js/commit/5dfa155a2621806aec891d73f960912a246335d8))
* **payment:** PAYMENTS-4759 Support for account Instruments ([9fc0e73](https://github.com/bigcommerce/checkout-sdk-js/commit/9fc0e733db3fa54be46e7fd61f2088b31a15d55e))
...
* **payment:** PAYPAL-675 Upgrade to 3DS v2 Braintree ([05f63ca](https://github.com/bigcommerce/checkout-sdk-js/commit/05f63cadcf07019ff02f3bbb9a74cd52a770880f))
* **payment:** PAYPAL-675 Upgrade to 3DS v2 Braintree ([d755b69](https://github.com/bigcommerce/checkout-sdk-js/commit/d755b69586603b350dc0b6e4c78fe05fc2206995))
* **payment:** PAYPAL-7 Pass in merchant ID on PayPal button script for PayPal Express Checkout ([8044df2](https://github.com/bigcommerce/checkout-sdk-js/commit/8044df22b714020444a523e96ee96b7c89b010b8))
...
* **shipping:** CHECKOUT-4509 Optional param to include shippings options when updating shipping address ([132075c](https://github.com/bigcommerce/checkout-sdk-js/commit/132075c6d4b09219d3b2ccb93c8f0b1b7ddfcfb6))
...
* **checkout:** CHECKOUT-3365 Update cart and checkout state when shipping options are loaded ([05c80bf](https://github.com/bigcommerce/checkout-sdk-js/commit/05c80bf7e4aae6f9d8c665239b8d72c701e5b772))
...
* **checkout:** CHECKOUT-4513 Add extendedComparisonPrice from API ([a3f56d9](https://github.com/bigcommerce/checkout-sdk-js/commit/a3f56d916cddbcd0cb176317777c9342699d891c))
...
* **common:** PAYMENTS-4802 Fix ArrayReplace default comparison ([c4f2b19](https://github.com/bigcommerce/checkout-sdk-js/commit/c4f2b19297323469b5895a60559c97daab38843e))
* **embedded-checkout:** CHECKOUT-4462 Only retry again if sufficient time has passed ([b7567ad](https://github.com/bigcommerce/checkout-sdk-js/commit/b7567ad42170824bd52d61ea631881199f444c7e))
* **embedded-checkout:** CHECKOUT-4462 Only trigger event handler if type matches ([b5263c5](https://github.com/bigcommerce/checkout-sdk-js/commit/b5263c5897ca902ad7eafda31d01151d2638b36e))
...
* **order:** CHECKOUT-4450 Fix recaptcha iframe not found for german language ([94cd8a7](https://github.com/bigcommerce/checkout-sdk-js/commit/94cd8a7555d8eda2e07229d8188762004e603102))
* **order:** CHECKOUT-4450 Handle recaptcha challenge not finish loading on slow connection ([62c3f73](https://github.com/bigcommerce/checkout-sdk-js/commit/62c3f737c0c1aa3d3a0b42ebc1ac6080733c1dac))
...
* **payment:** INT-1928 map sku in internal line item ([fcb32dd](https://github.com/bigcommerce/checkout-sdk-js/commit/fcb32ddc8f2caab28c0e7399ce412ee155c03af8))
...
* **payment:** PAYMENTS-4616 Add braintree.paypal as a supported instrument ([e532a19](https://github.com/bigcommerce/checkout-sdk-js/commit/e532a1970e31e96baa0ad67ac353fceff0d2e359))
* **payment:** PAYMENTS-4704 Send shipping address when checking out using Braintree PayPal ([b047cfe](https://github.com/bigcommerce/checkout-sdk-js/commit/b047cfe994b7222b9b7f5b9b11f01b9010c1fe3a))
* **payment:** PAYMENTS-4759 Make Instrument types backward compatible ([f700b45](https://github.com/bigcommerce/checkout-sdk-js/commit/f700b45bebb00a0cda825db18a4785a775282291))
* **payment:** PAYMENTS-4971 Remove extra keys from Braintree PayPal Tokenize call ([33ef094](https://github.com/bigcommerce/checkout-sdk-js/commit/33ef094f395b066802e73570a99bff359a809371))
* **payment:** PAYMENTS-4971 Remove extra keys from Braintree PayPal Tokenize call ([90755fb](https://github.com/bigcommerce/checkout-sdk-js/commit/90755fb9da90c8647eb9d34ba67b3333cb47ecf0))
...
* **shipping:** SHIPPING-1384 Extend shipping option interface ([a6a850a](https://github.com/bigcommerce/checkout-sdk-js/commit/a6a850ae151166e8b2f9d44d3b6036ad170f1481))
...
* **common:** CHECKOUT-4455 Upgrade `script-loader` version ([dc5b3e5](https://github.com/bigcommerce/checkout-sdk-js/commit/dc5b3e586ac99016c6cc2d8f9e2330263eb72b33))
* **common:** CHECKOUT-4485 Fix inconsistency in import statements by using `eslint-plugin-import` plugin ([71980ef](https://github.com/bigcommerce/checkout-sdk-js/commit/71980ef5ec64693851a1b8856ca559df091c12ea))
* **common:** CHECKOUT-4485 Use ESLint to enforce use of newline in import statements ([3da456b](https://github.com/bigcommerce/checkout-sdk-js/commit/3da456b9ffdbb5d162daf0734e526f51b3b41c22))
...
* **payment:** PAYMENTS-4616 Use an object for paypal configuration ([b743c39](https://github.com/bigcommerce/checkout-sdk-js/commit/b743c3989e984dba9b463b44c6471ce79017370e))
* **payment:** PAYMENTS-4616 Use paypal_account for sending paypal information to bigpay ([cd1abbe](https://github.com/bigcommerce/checkout-sdk-js/commit/cd1abbe232143159235814b1045f35f3000b74c2))
